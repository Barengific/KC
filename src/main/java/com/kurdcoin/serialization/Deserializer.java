package com.kurdcoin.serialization;

import com.kurdcoin.utils.StringUtils;
...
//	}
	...
	public final byte[] readBytes(final String label) {
		return this.readBytes(label, 2048);
	}
	...
	public final byte[] readOptionalBytes(final String label) {
		return this.readOptionalBytes(label, 2048);
	}
	...
	public final String readString(final String label, final int limit) {
		...
		if (StringUtils.isNullOrWhitespace(value)) {
			System.out.println("value null: " + label);;
		}
